 ...
 * @id $Id$
 */
public final class TairSessionClient implements SessionClient {
    ...
    /** 日志 */
    private static final Logger log = LoggerFactory.getLogger(TairSessionClient.class);
    ...
    public static synchronized SessionClient getInstance() {
        if (instance == null) {
            instance = new TairSessionClient();
        }
        return instance;
    }
